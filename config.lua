Config = {
    ...
    -- Set this to '' to disable the key.
    MenuKeybind = 'f4', -- List of keys here: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    -- You can change the menu position here.
    MenuPosition = 'bottom-right', -- (top-left, top-right, bottom-left, bottom-right)
